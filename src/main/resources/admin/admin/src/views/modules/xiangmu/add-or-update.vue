               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="监造地点" prop="xiangmuAddress">
                       <el-input v-model="ruleForm.xiangmuAddress"
                                 placeholder="监造地点" clearable  :readonly="ro.xiangmuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiangmuFile" label="建造资料" prop="xiangmuFile">
                        <file-upload
                                tip="点击上传建造资料"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmuFile" label="建造资料" prop="xiangmuFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.xiangmuFile"  >建造资料下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="监造数量" prop="xiangmuKucunNumber">
                       <el-input v-model="ruleForm.xiangmuKucunNumber"
                                 placeholder="监造数量" clearable  :readonly="ro.xiangmuKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.shenqingTime"  class="input" label="申请时间" prop="shenqingTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shenqingTime" label="申请时间" prop="shenqingTime">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.nachuanTime"  class="input" label="拿船时间" prop="nachuanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.nachuanTime"
                                type="datetime"
                                placeholder="拿船时间"
                                :disabled="ro.nachuanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.nachuanTime" label="拿船时间" prop="nachuanTime">
                            <span v-html="ruleForm.nachuanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xiangmuContent"  label="监造要求" prop="xiangmuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuContent" label="监造要求" prop="xiangmuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xiangmuAddress: [
                              { required: true, message: '监造地点不能为空', trigger: 'blur' },
                          ],
                   xiangmuFile: [
                              { required: true, message: '建造资料不能为空', trigger: 'blur' },
                          ],
                   xiangmuTypes: [
                   ...
                   xiangmuKucunNumber: [
                              { required: true, message: '监造数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   nachuanTime: [
                              { required: true, message: '拿船时间不能为空', trigger: 'blur' },
                          ],
                   xiangmuContent: [
                              { required: true, message: '监造要求不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
