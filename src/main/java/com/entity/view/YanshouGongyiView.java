...
public class YanshouGongyiView extends YanshouGongyiEntity implements Serializable {
	...
	*/
	...
	public YanshouGongyiView() {

	}

	public YanshouGongyiView(YanshouGongyiEntity yanshouGongyiEntity) {
		try {
			BeanUtils.copyProperties(this, yanshouGongyiEntity);
