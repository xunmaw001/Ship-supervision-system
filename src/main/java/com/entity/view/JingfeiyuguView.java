...
public class JingfeiyuguView extends JingfeiyuguEntity implements Serializable {
	...
	*/
	...
	public JingfeiyuguView() {

	}

	public JingfeiyuguView(JingfeiyuguEntity jingfeiyuguEntity) {
		try {
			BeanUtils.copyProperties(this, jingfeiyuguEntity);
