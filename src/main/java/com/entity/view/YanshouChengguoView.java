...
public class YanshouChengguoView extends YanshouChengguoEntity implements Serializable {
	...
	*/
	...
	public YanshouChengguoView() {

	}

	public YanshouChengguoView(YanshouChengguoEntity yanshouChengguoEntity) {
		try {
			BeanUtils.copyProperties(this, yanshouChengguoEntity);
