...
public class YanshouCailiaoView extends YanshouCailiaoEntity implements Serializable {
	...
	*/
	...
	public YanshouCailiaoView() {

	}

	public YanshouCailiaoView(YanshouCailiaoEntity yanshouCailiaoEntity) {
		try {
			BeanUtils.copyProperties(this, yanshouCailiaoEntity);
