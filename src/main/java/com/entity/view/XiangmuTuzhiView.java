...
public class XiangmuTuzhiView extends XiangmuTuzhiEntity implements Serializable {
	...
	* 图纸类型的值
	*/
	@ColumnInfo(comment="图纸类型的字典表值",type="varchar(200)")
	private String xiangmuTuzhiValue;
	/**
	* 申请状态的值
	*/
	@ColumnInfo(comment="申请状态的字典表值",type="varchar(200)")
	private String xiangmuTuzhiYesnoValue;
	...
	public XiangmuTuzhiView() {

	}

	public XiangmuTuzhiView(XiangmuTuzhiEntity xiangmuTuzhiEntity) {
		try {
			BeanUtils.copyProperties(this, xiangmuTuzhiEntity);
	...
	* 获取： 图纸类型的值
	*/
	public String getXiangmuTuzhiValue() {
		return xiangmuTuzhiValue;
	}
	/**
	* 设置： 图纸类型的值
	*/
	public void setXiangmuTuzhiValue(String xiangmuTuzhiValue) {
		this.xiangmuTuzhiValue = xiangmuTuzhiValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	*/
	public String getXiangmuTuzhiYesnoValue() {
		return xiangmuTuzhiYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setXiangmuTuzhiYesnoValue(String xiangmuTuzhiYesnoValue) {
		this.xiangmuTuzhiYesnoValue = xiangmuTuzhiYesnoValue;
	}
	...
	public String toString() {
		return "XiangmuTuzhiView{" +
			", xiangmuTuzhiValue=" + xiangmuTuzhiValue +
			", xiangmuTuzhiYesnoValue=" + xiangmuTuzhiYesnoValue +
