...
public class JianzaojinduView extends JianzaojinduEntity implements Serializable {
	...
	* 进度类型的值
	*/
	@ColumnInfo(comment="进度类型的字典表值",type="varchar(200)")
	private String jianzaojinduValue;
	...
	public JianzaojinduView() {

	}

	public JianzaojinduView(JianzaojinduEntity jianzaojinduEntity) {
		try {
			BeanUtils.copyProperties(this, jianzaojinduEntity);
	...
	* 获取： 进度类型的值
	*/
	public String getJianzaojinduValue() {
		return jianzaojinduValue;
	}
	/**
	* 设置： 进度类型的值
	*/
	public void setJianzaojinduValue(String jianzaojinduValue) {
		this.jianzaojinduValue = jianzaojinduValue;
	}
	...
	public String toString() {
		return "JianzaojinduView{" +
			", jianzaojinduValue=" + jianzaojinduValue +
